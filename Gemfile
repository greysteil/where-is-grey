...
gem 'activerecord', '6.0.3.3'        # Object-relational mapper
gem 'pg', '~> 1.2.3'                 # PostgreSQL gem
gem 'sinatra-activerecord', '2.0.18' # Sinatra setup for AR
...
gem 'exifr', '~> 1.3.8'              # Read image metadata, including GPS data
gem 'google-api-client', '~> 0.46.0' # Pull images from Google Drive
...
group :test do
  ...
  gem 'webmock', '~> 3.9.1'          # Mocking API calls
