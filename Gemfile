...
gem 'activerecord', '5.1.2'          # Object-relational mapper
...
gem 'spot-gps', '~> 0.2.5'           # Client library for SPOT GPS tracker
gem 'exifr', '~> 1.3.0'              # Read image metadata, including GPS data
gem 'google-api-client', '~> 0.13.0'  # Pull images from Google Drive
