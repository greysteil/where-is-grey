...
gem 'sinatra', '2.2.0'               # Web framework
gem 'puma'                           # Web server

gem 'activerecord', '7.0.2.2'        # Object-relational mapper
gem 'pg', '~> 1.3.3'                 # PostgreSQL gem
...
gem 'spot-gps', '~> 0.3.0'           # Client library for SPOT GPS tracker
...
group :test do
  gem 'rspec', '~> 3.11'             # Testing framework
